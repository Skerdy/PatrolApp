...
public class TutorialActivity extends AppCompatActivity {
    ...
    private boolean validate() {
        ...
        if(titulli == null || titulli.length()==0){
            if(flag)
                Toast.makeText(this, "Ju lutem fusni nje titull", Toast.LENGTH_SHORT).show();
            flag=false;
        }
        if(grada == null || grada.length()==0){
            if(flag)
                Toast.makeText(this, "Ju lutem fusni nje grade", Toast.LENGTH_SHORT).show();
            flag=false;
        }
        return flag;
    }
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    tp = TutorialPane.newInstance(R.layout.fragment_tutorial_one,0);
                    break;
                case 1:
                    tp = TutorialPane.newInstance(R.layout.fragment_tutorial_two,1);
                    break;
                case 2:
                    tp = TutorialPane.newInstance(R.layout.fragment_tutorial_three,2);
                    break;
                case 3:
